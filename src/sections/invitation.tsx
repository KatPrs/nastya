...
export const Invitation = () => (
  <section className="flex flex-col items-center text-center px-4 py-8">
    {/* Текст приглашения */}
    <div className="mb-12 text-[11px] md:text-lg max-w-lg mx-auto uppercase leading-relaxed">
  ...
  <p>день нашей свадьбы!</p>
    ...
    <div className="relative px-4">
      <h3 className="text-xl md:text-3xl font-bold mb-1">УСАДЬБА «ВОЛОДИНО»</h3>
      ...
      <div className="absolute -top-10 -right-10 sm:-right-24 md:-right-40 w-20 md:w-32 scale-75 md:scale-100">
